...
const LecturePopup = ({ lessons }) => {
  ...
  return (
    <div>
      <div className="my-lecture-popup">
        <div className="my-lecture-popup-content">
          <h3>Lectures</h3>
          <ul className="my-lecture-list">
            {lessonsToDisplay.map((lesson) => (
              <li key={lesson._id} className="my-lecture-item">
                <h4>{lesson.title}</h4>
